...
def init_components(
    ...
    Returns:
        TFX components
    """
    # Define ExampleGen to read data
    ...
    # Define slicing specs for evaluation
    slicing_specs = [
        tfma.SlicingSpec(),
        tfma.SlicingSpec(feature_keys=["study_hours", "sleep_hours"])
    ]
    ...
    eval_config = tfma.EvalConfig(
        model_specs=[tfma.ModelSpec(label_key='Stress_Level')],
    ...
    # Push the model to the serving directory
    pusher = Pusher(
        model=trainer.outputs["model"],
